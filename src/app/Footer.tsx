      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-x-12 gap-y-16 md:col-span-3 lg:grid-cols-6">
          <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
            <div className="text-2xl font-bold">OpticShop365</div>
            <p className="mt-7 text-base leading-relaxed text-muted-foreground">
              Discover a wide range of quality eyewear that suits your style and
              vision needs. Experience the clarity and comfort with
              OpticShop365.
            </p>
